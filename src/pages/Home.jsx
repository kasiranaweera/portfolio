...
const Home = () => {
  const recentProjects = [
    ...
    
    {
      ...
      description:
        "A sophisticated financial AI assistant powered by LangChain and Gemini API with RAG system. Provides real-time market insights, portfolio analysis, investment recommendations, and financial guidance through intelligent retrieval-augmented generation.",
    ...
    },
    {
      ...
      description:
        "A specialized fine-tuned version of Gemma-4 language model optimized for educational content generation and student support. Uses LoRA fine-tuning on comprehensive educational datasets to deliver personalized learning materials and adaptive tutoring.",
